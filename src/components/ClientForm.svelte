<script>
  ...
  import ContractTitle from "./ContractTitle.svelte";
  import ContractSides from "./contractSides/ContractSides.svelte";
  import ContractWhereas from "./ContractWhereas.svelte";
  ...
  import ContractProducts from "./ContractProducts.svelte";
  ...
  const wheres = [
    ...
    {
      text: "והואיל וברצון הצדדים להתקשר בהסכם התקשרות זה תוך שהצדדים מצהירים כי אין בינם ולא התקיימו בינם ולא יתקיימו בינם יחסי עובד מעביד;",
    },
  ];
